...
/**
 * Created by Panwar on 16/11/16.
 */
public class Trending_Pro_Adapter_Product_Page extends BaseAdapter {
    ...
    public Trending_Pro_Adapter_Product_Page(Context landingHome, ArrayList<HashMap<String,String>> data){
...
//        Log.d("Inside adapter size",""+getCount());
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.adv_horizontal_layout, null);
        ...
        Typeface tf2    =   Typeface.createFromAsset(context.getAssets(),"Montserrat-Regular.otf");

...
import com.lions.sparsh23.laltern.adapters.MyItemRecyclerViewAdapter;
 ...
 * interface.
 */
public class ItemFragment_Search extends Fragment {
   ...
   // ArrayList<String> day_radio;
     ...
     */
    public ItemFragment_Search() {
    }

    // TODO: Customize parameter initialization
    @SuppressWarnings("unused")
    public static ItemFragment_Search newInstance(int columnCount)
    {
        ItemFragment_Search fragment = new ItemFragment_Search();
                             ...
                             Bundle savedInstanceState)
    {
        ...
        recyclerView.setAdapter(new MyItemRecyclerViewAdapter(map, (ItemFragment.OnListFragmentInteractionListener) mListener, getContext(),1));
       ...
       // Toast.makeText(getContext(),""+ARG_CAT+" "+ARG_SUB+" "+ARG_UID+"",Toast.LENGTH_SHORT).show();
        ...
        final SnappyLinearLayoutManager layoutManager1 = new SnappyLinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false) {
            @Override
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
                SnappySmoothScroller scroller = new SnappySmoothScroller.Builder()
                        .setPosition(position)
        ...
        filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(filtermap!=null&&filtermap.size()>0)
                {
                    ...
                    Log.d("inside","itemfragment_search");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(imageView.isChecked())
                {
                    ...
                    recyclerView.setAdapter(new MyItemRecyclerViewAdapter(map, (ItemFragment.OnListFragmentInteractionListener) mListener, getContext(),2));
                }
                if(!imageView.isChecked()){
...
// TODO Auto-generated method stub
                                ...
                                if(which==0){
                                    ...
                                    recyclerView.setAdapter(new MyItemRecyclerViewAdapter(sorteddata, (ItemFragment.OnListFragmentInteractionListener) mListener, getContext(),2));

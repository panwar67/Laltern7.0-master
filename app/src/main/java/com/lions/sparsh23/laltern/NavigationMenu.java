...
import com.lions.sparsh23.laltern.adapters.ExpandableListAdapter;
import com.lions.sparsh23.laltern.adapters.GridSubcatAdapter;
import com.lions.sparsh23.laltern.adapters.LandingHomeListAdapter;
import com.lions.sparsh23.laltern.adapters.Top_Pro_Adapter;
import com.lions.sparsh23.laltern.adapters.TrendingProAdapter;
...
sessionManager = new SessionManager(getApplicationContext());
      ...
      final   ExpandableHeightGridView gridView = (ExpandableHeightGridView)findViewById(R.id.expandgrid);
        ...
        try{
            ...
            data_suicide.add(craft_data.get(0));
...
//        onNavigationItemSelected(navigationView.getMenu().getItem(0));
        ...
        ExpandableListAdapter expandableListAdapter = new ExpandableListAdapter(listDataChild,listDataHeader,getApplicationContext());
